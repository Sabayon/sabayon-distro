...
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="connman +consolekit cron doc networkmanager nsplugin pm-utils +policykit +portage entropy static-libs test udev"
...
src_prepare() {
	...
	epatch "${FILESDIR}/${P}-fix-entropy-compatibility-2.patch"
	epatch "${FILESDIR}/${P}-fix-crash-in-removal-dependency-calculation.patch"
}
