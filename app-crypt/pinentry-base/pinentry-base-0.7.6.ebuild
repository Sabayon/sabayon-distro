...
SRC_URI="mirror://gnupg/${PN/-base}/${P/-base}.tar.gz"
...
pkg_postinst() {
	...
	elog "your users."
	elog "If you want pinentry for GTK, please install app-crypt/pinentry-gtk."
	elog "If you want pinentry for Qt4, please install app-crypt/pinentry-qt4."
}
