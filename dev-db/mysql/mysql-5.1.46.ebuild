...
# $Header: /var/cvsroot/gentoo-x86/dev-db/mysql/mysql-5.1.46.ebuild,v 1.2 2010/05/15 12:16:14 darkside Exp $
...
src_install() {
	mysql_src_install
	# $(BUILDDIR_PIC)/libmysqld/libmysqld.a $(TMP)/usr/lib/mysql/libmysqld_pic.a
}
