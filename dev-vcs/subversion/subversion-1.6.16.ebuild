...
inherit autotools bash-completion db-use depend.apache elisp-common eutils flag-o-matic libtool multilib perl-module python
...
#		fi
		...
		if use java; then
			print "                                          (Testing of Java binding: enable test and install dev-vcs/subversion-java)"
		fi
		print
		print --red "************************************************************************************************"
		print
