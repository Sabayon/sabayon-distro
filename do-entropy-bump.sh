...
OLD=$1
NEW=$2
PACKAGES="sys-apps/entropy sys-apps/entropy-client-services app-admin/equo app-admin/spritz sys-apps/entropy-server app-admin/entropy-notification-applet"
