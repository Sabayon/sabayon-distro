...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdm/kdm-3.5.10.ebuild,v 1.1 2008/09/13 23:58:26 carlo Exp $
...
PATCHES="${FILESDIR}/kdm-dbus-session-support.patch ${FILESDIR}/kdm-sabayon-theme-default.patch ${FILESDIR}/kdm-autologinagain.patch"
