...
SRC_URI="${SRC_URI} http://www.sabayonlinux.org/distfiles/kde-base/${PN}/kdebase-3.5-patchset-99.tar.bz2"
...
src_unpack() {
        ...
        # Add Kickoff support
        epatch "${WORKDIR}/patches/kicker-3.5.5.kickoff.diff"

	# Adjust fonts
        epatch "${FILESDIR}/kickoff-sabayonlinux-integration.patch"
