...
# $Header: /var/cvsroot/gentoo-x86/kde-base/oxygen-icons/oxygen-icons-4.7.0.ebuild,v 1.1 2011/07/27 14:04:32 alexxy Exp $
...
[[ ${PV} == *9999 ]] || \
SRC_URI="
	!bindist? ( http://dev.gentoo.org/~alexxy/${MY_P}.tar.xz )
