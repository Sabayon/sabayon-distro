...
PATCHES=(
	...
	"${FILESDIR}"/0000-simplification.patch
	"${FILESDIR}"/0001-make-them-all-uniqueconnections.patch
	"${FILESDIR}"/0002-try-to-avoid-doing-any-work-while-we-are-deleting.patch
)
