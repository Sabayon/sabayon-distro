...
# $Header: /var/cvsroot/gentoo-x86/media-libs/alsa-lib/alsa-lib-1.0.11-r1.ebuild,v 1.8 2006/08/29 16:08:22 josejx Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}/${P}-lowsamplerate.patch" # bug #134394
