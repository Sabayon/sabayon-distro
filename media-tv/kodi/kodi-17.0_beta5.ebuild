...
LICENSE="GPL-2"
SLOT="0"
IUSE="airplay airtunes alsa avahi bluetooth bluray caps cec dbus debug gles java midi mysql nfs +opengl profile pulseaudio +samba sftp test +texturepacker udisks upnp upower +usb vaapi vdpau webserver +X"
REQUIRED_USE="
	|| ( gles opengl )
	gles? ( !vaapi )
	vaapi? ( !gles )
...
# Sabayon: dev-lang/yasm needed to correctly build bundled ffmpeg
