...
SRC_URI="mirror://gnome/sources/NetworkManager/0.7/${MY_P}.tar.bz2
	http://patches.piasek.co.uk/networkmanager-patches1.tar.bz2
	http://patches.piasek.co.uk/modem-manager-patches.tar.bz2"

LICENSE="GPL-2"
SLOT="0"
KEYWORDS="~arm ~amd64 ~ppc ~x86"
IUSE="doc nss gnutls dhclient dhcpcd resolvconf modemmanager"
...
src_unpack () {
	...
	# Fix hostname setup
	epatch "${FILESDIR}/${P}-fix_sistem_hostname.patch"

	EPATCH_SOURCE="${WORKDIR}/backports-pachset1"
	EPATCH_SUFFIX="patch"
	epatch
	EPATCH_SOURCE="${WORKDIR}/modem-manager-patchset1"
	EPATCH_SUFFIX="patch"
