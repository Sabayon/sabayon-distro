...
# $Header: /var/cvsroot/gentoo-x86/sys-fs/lvm2/lvm2-2.02.51.ebuild,v 1.2 2009/09/07 13:41:34 armin76 Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${PN}-2.02.51-fix-pvcreate-freeze.patch
	eautoreconf
}
