...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/genkernel/genkernel-3.4.10.908.ebuild,v 1.1 2010/12/25 00:29:24 sping Exp $
...
src_unpack() {
	...
	# Add crypt support
	epatch "${FILESDIR}"/${PN}-crypt-config-2.patch
