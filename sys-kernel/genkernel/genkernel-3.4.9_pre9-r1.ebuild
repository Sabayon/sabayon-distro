...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/genkernel/genkernel-3.4.9_pre9-r1.ebuild,v 1.1 2007/11/16 23:19:58 wolf31o2 Exp $
...
src_unpack() {
	...
	# Add UnionFS support
	epatch ${FILESDIR}/genkernel-3.4.9-unionfs-inkernel-support-new-2.patch
