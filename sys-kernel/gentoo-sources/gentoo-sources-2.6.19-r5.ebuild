...
src_unpack() {
	...
	cd ${S}
	patch -p1 < ${FILESDIR}/2.6.19-kvm-experimental-support.patch  > /dev/null || die patch failed
	patch -p1 < ${FILESDIR}/2.6.19-kvm-2.6.20_rc4-updates.patch  > /dev/null || die patch failed
