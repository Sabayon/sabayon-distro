...
SL_PATCHES_URI="
		http://www.sabayonlinux.org/distfiles/sys-kernel/${PN}/ipw3945-1.2.0-${PV/_*}.patch
		http://www.sabayonlinux.org/distfiles/sys-kernel/${PN}/squashfs-3.2-2.6.20.patch
...
UNIPATCH_LIST="
		...
		${FILESDIR}/2.6.20-mactel.patch ${FILESDIR}/${P}-kvm-compile-fix.patch
		"
