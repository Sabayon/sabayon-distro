...
SRC_URI="http://www.sabayonlinux.org/distfiles/sys-kernel/${PN}/${P}-${PR}.tar.bz2"
RESTRICT="nomirror"
S=${WORKDIR}/${P}-${PR}
...
pkg_postinst() {
	...
	einfo "x86 Edition: http://www.sabayonlinux.org/sabayon/kconfigs/SabayonLinux-x86-3.4.Loop2b.config"
	einfo "x86-64 Edition: http://www.sabayonlinux.org/sabayon/kconfigs/SabayonLinux-x86_64-3.4.Loop2b.config"
