...
UNIPATCH_LIST="
		${FILESDIR}/${P}-wireless-dev.patch ${FILESDIR}/${P}-dvb-af9005-updated.patch
		...
		${FILESDIR}/${P}-libertas-wireless-driver.patch ${FILESDIR}/${PN}-2.6.21-git-20070402-dvb.patch
