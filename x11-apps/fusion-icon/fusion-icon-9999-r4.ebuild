...
COMPIZ_RELEASE=0.7.4
COMPIZ_FUSION_RELEASE=0.7.4
...
src_unpack() {
	...
	git_fetch || die "Problem fetching from git repository."
	git_bootstrap || die "Prolem running bootstrap."

	# setup.py does not copy the 32px file.
	epatch "${FILESDIR}"/hicolor-icons-32.patch
}
