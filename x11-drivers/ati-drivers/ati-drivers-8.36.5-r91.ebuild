...
src_install() {
	...
	sed -i 's/\xe8\xec\x4f\xfe\xff\x85\xc0\x7f\x31/\xe8\xec\x4f\xfe\xff\x85\xc0\x90\x90/' ${S}/x710/usr/X11R6/lib/modules/drivers/fglrx_drv.so
	sed -i 's/\xe8\xaa\x72\xfe\xff\x85\xc0\x7f\x23/\xe8\xaa\x72\xfe\xff\x85\xc0\x90\x90/' ${S}/x710_64a/usr/X11R6/lib64/modules/drivers/fglrx_drv.so
	sed -i 's/\x0f\x88\x3c\x09\x00\x00/\x90\xe9\x3c\x09\x00\x00/' ${S}/x710/usr/X11R6/lib/modules/drivers/fglrx_drv.so
	sed -i 's/\x0f\x88\x3b\x08\x00\x00/\x90\xe9\x3b\x08\x00\x00/' ${S}/x710_64a/usr/X11R6/lib64/modules/drivers/fglrx_drv.so
