...
# $Header: /var/cvsroot/gentoo-x86/x11-drivers/ati-drivers/ati-drivers-8.443.1-r1.ebuild,v 1.2 2007/12/24 19:16:46 je_fro Exp $
...
SRC_URI="${ATI_URL}/ati-driver-installer-${MY_PV}-x86.x86_64.run"
SLOT="0"
