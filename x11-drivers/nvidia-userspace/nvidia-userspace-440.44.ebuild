...
EAPI=7
inherit desktop eutils flag-o-matic linux-info linux-mod multilib nvidia-driver \
...
IUSE="acpi compat gtk3 kernel_FreeBSD kernel_linux libglvnd kms multilib static-libs tools uvm wayland +X"
REQUIRED_USE="
	tools? ( X )
	static-libs? ( tools )
"
