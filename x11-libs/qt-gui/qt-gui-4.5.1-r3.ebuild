...
src_prepare() {
	...
	# QGraphicsView don't show children patch
	# http://websvn.kde.org/trunk/qt-copy/patches/0285-qgv-dontshowchildren.diff?view=log
	epatch "${FILESDIR}"/qt-copy/0285-qgv-dontshowchildren.diff
