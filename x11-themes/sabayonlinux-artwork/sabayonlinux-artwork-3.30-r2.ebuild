...
SRC_URI="
	http://www.sabayonlinux.org/distfiles/x11-themes/${PN}/${PN}-${PV}-r1.tar.bz2
	http://www.sabayonlinux.org/distfiles/x11-themes/${PN}/oxygen.tar.bz2
	"
LICENSE="GPL-2"
SLOT="0"
...
src_install () {
	...
	insinto /usr/share/beryl/
	doins *.png

	# Also, Oxygen icons, but do not enable them by default
